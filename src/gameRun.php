...
class Battle
{
    ...
    public function whoAttacksFirst()
    {
        ...
        else if($this->julien->getSpeed()>$this->monster->getSpeed())
        {
            return true;
        }
        else if($this->julien->getSpeed()==$this->monster->getSpeed())
        {
            ...
            else if($this->julien->getLuck()<$this->monster->getLuck())
            {
                return false;
            }
            else if($this->julien->getLuck()==$this->monster->getLuck())
        ...
        while($turn<=$stats['NumberOfRounds'])
        {
            foreach($abilities as $ability)
            {
                ...
                if($whoGoesFirst==true)
                {
                    ...
                    else if($random<=$this->monster->getLuck())
                    {
                ...
                else if($whoGoesFirst==false)
                {
                    ...
                    //Hero dodged message
                    else if($random<=$this->julien->getLuck())
                    {
